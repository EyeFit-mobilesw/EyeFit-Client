...
| 👀서문지 | PM, Front-end, Back-end | [SEOMUNJI](https://github.com/SEOMUNJI)  | UI/UX 디자인, 홈 화면 및 하루 습관 체크·분석 페이지 프론트엔드 구현, Firebase 연동(Auth/Firestore) 및 데이터 저장·조회 처리, 보고서 작성, 발표자료 제작 |
